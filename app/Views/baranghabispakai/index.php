...
<?= $this->section('judul') ?>Barang Habis Pakai Produksi<?= $this->endSection('judul') ?>
<?= $this->section('isi') ?>
<?php
$canManage = \App\Libraries\AccessControl::can('master.stok_habis_pakai.manage_stock');
...
<div class="card bhp-tab-card">
    <div class="card-header pb-0">
        <ul class="nav nav-tabs bhp-tabs" id="bhpTabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="tab-master-link" data-toggle="tab" href="#tab-master" role="tab"><i class="fas fa-boxes mr-1"></i> Master Stok</a></li>
            <?php if ($canReceive): ?><li class="nav-item"><a class="nav-link" id="tab-receive-link" data-toggle="tab" href="#tab-receive" role="tab"><i class="fas fa-truck-loading mr-1"></i> Penerimaan Vendor</a></li><?php endif; ?>
            <?php if ($canRequest): ?><li class="nav-item"><a class="nav-link" id="tab-request-link" data-toggle="tab" href="#tab-request" role="tab"><i class="fas fa-paper-plane mr-1"></i> Permintaan Produksi</a></li><?php endif; ?>
            <?php if ($canApprove): ?><li class="nav-item"><a class="nav-link" id="tab-approval-link" data-toggle="tab" href="#tab-approval" role="tab"><i class="fas fa-check-circle mr-1"></i> Persetujuan <?php if ($pendingCount > 0): ?><span class="badge badge-danger"><?= $pendingCount ?></span><?php endif; ?></a></li><?php endif; ?>
            <li class="nav-item"><a class="nav-link" id="tab-log-link" data-toggle="tab" href="#tab-log" role="tab"><i class="fas fa-history mr-1"></i> Log Mutasi</a></li>
        </ul>
    </div>
    <div class="card-body">
