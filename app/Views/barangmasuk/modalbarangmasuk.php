<div class="modal fade" id="modalbarangmasuk" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('barangmasuk/simpanPembayaran', ['class' => 'frmbarangmasuk']) ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.frmbarangmasuk').submit(function(e) {
            e.preventDefault();
