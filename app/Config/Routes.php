...
$routes->get('materialretur/kelola/(:segment)', 'Materialretur::kelola/$1');
$routes->post('materialretur/koreksi', 'Materialretur::koreksi');
$routes->post('materialretur/hapusDetail', 'Materialretur::hapusDetail');
$routes->get('barangmasuk/retur/(:segment)', 'Produkretur::form/$1');
$routes->post('produkretur/simpan', 'Produkretur::simpan');
$routes->get('produkretur/kelola/(:segment)', 'Produkretur::kelola/$1');
$routes->post('produkretur/koreksi', 'Produkretur::koreksi');
$routes->post('produkretur/hapusDetail', 'Produkretur::hapusDetail');
