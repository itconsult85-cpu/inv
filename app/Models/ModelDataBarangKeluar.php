...
class ModelDataBarangKeluar extends Model
{
    ...
    protected $column_order = array(null, 'faktur', 'detpo', 'tglfaktur', 'pelnama', 'qtykeluar', 'totalberatbarang', null);
    protected $column_search = array('faktur', 'detpo', 'tglfaktur', 'pelnama');
