...
class Modeldatabarangmasuk extends Model
{
    ...
    protected $column_order = array(null, 'faktur', 'tglfaktur', 'supnama', 'qtymasuk', 'gdgnama', 'totalberatbarang', 'satuan', null);
